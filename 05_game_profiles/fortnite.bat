...
cd /d "%~dp0"
title naveboost turbo pro 7.5 adaptive - fortnite
echo perfil fortnite competitivo.
echo recurso: prioridade temporaria abovenormal + priorityboost, sem injecao ou patch.
call "%~dp0..\00_core\game_session_apply.bat" "fortniteclient-win64-shipping.exe" "competitive"
set "rc=%errorlevel%"
echo.
