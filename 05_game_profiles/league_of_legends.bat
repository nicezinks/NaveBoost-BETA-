...
cd /d "%~dp0"
title naveboost turbo pro 7.5 adaptive - league_of_legends
echo perfil league of legends competitivo.
echo recurso: prioridade temporaria abovenormal + priorityboost, sem injecao ou patch.
call "%~dp0..\00_core\game_session_apply.bat" "leagueclient.exe" "competitive"
set "rc=%errorlevel%"
echo.
